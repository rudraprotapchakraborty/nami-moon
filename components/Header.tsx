      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm">
          ...
          <Link href="/booking">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button className="bg-custom-red-600 hover:bg-custom-red-700 text-white text-base transition-colors duration-300 rounded-full px-6 font-googly relative overflow-hidden group">
        ...
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetTrigger asChild className="md:hidden">
            <motion.button
              className="p-2 text-gray-300 hover:text-custom-red-400 transition-colors duration-200"
              whileTap={{ scale: 0.9 }}
            >
          ...
          <SheetContent
            side="right"
            className="w-[300px] bg-gray-900 text-gray-300 border-l border-gray-800"
          >
            <motion.div
            ...
            >
              ...
              >
                <Link href="/booking" onClick={() => setIsOpen(false)}>
                  <Button className="bg-custom-red-600 hover:bg-custom-red-700 text-white mt-4 w-full transition-all duration-300 rounded-full font-googly relative overflow-hidden group">
                    <span className="relative z-10">BOOK NOW</span>
                    <motion.span 
                      className="absolute inset-0 bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 opacity-0 group-hover:opacity-70 transition-opacity duration-500"
                      initial={{ x: '-100%' }}
