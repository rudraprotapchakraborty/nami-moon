...
import { Calendar, Users, Clock, MessageSquare, Phone, User, Send } from "lucide-react"
...
export default function BookingPageClient() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 relative z-10" ref={sectionRef}>
        <motion.div
          initial="hidden"
        ...
        >
          ...
          >
            <motion.div 
              ...
              custom={0}
            >
              <label htmlFor="name" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
            ...
            <motion.div 
              ...
              custom={1}
            >
              <label htmlFor="phoneNumber" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
            ...
            <motion.div 
              ...
              custom={2}
            >
              <label htmlFor="guests" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div 
                ...
                custom={3}
              >
                <label htmlFor="date" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
              ...
              <motion.div 
                ...
                custom={4}
              >
                <label htmlFor="time" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
            ...
            <motion.div 
              ...
              custom={5}
            >
              <label htmlFor="specialRequests" className="block text-lg font-medium mb-2 flex items-center gap-2 font-googly">
          ...
          >
            ...
            >
              ...
              <motion.p 
                ...
                transition={{ delay: 0.4 }}
              >
                Thank you for your reservation request. We will contact you shortly at{" "}
                <span className="text-white font-medium">{formData.phoneNumber || "your phone number"}</span> to confirm your booking.
              </motion.p>
              ...
              >
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div className="text-white">{formData.date.toLocaleDateString('en-US', { weekday: 'short', month: 'long', day: 'numeric' })}</div>
                  
                  <div className="text-gray-400">Time:</div>
                  <div className="text-white">{formData.time || "To be confirmed"}</div>
                  
                  <div className="text-gray-400">Guests:</div>
                  <div className="text-white">{formData.guests} {parseInt(formData.guests) === 1 ? "Guest" : "Guests"}</div>
                </div>
              </motion.div>
